...
! (Maio de 2017)
	...
	module Marsaglia
                ...
                logical, parameter :: get_seed  = .TRUE.	! se "get_seed  = .TRUE." le arquivo "seedin.rng"
...
!============================================================================
	...
	program direto
	use Marsaglia
	integer*8, parameter :: ni = 1
	integer*8, parameter :: nf = 100
	integer*8, parameter :: nm = 50
	integer*8            :: k
	real*8               :: xr
...
! Inicializacao do RNG
	...
	open(100,file="sequencia_meio2.dat")
